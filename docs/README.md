...
- RAG: [chunking](rag/CHUNKING_STRATEGY.md), [retrieval](rag/RETRIEVAL_STRATEGY.md), [prompting](rag/PROMPTING_STRATEGY.md), [citations](rag/CITATION_STRATEGY.md), [evaluation](rag/EVALUATION_STRATEGY.md)
- Development: [guide](development/DEVELOPMENT_GUIDE.md), [testing](development/TESTING_STRATEGY.md), [branching](development/BRANCHING_STRATEGY.md), [pull requests](development/PULL_REQUEST_PROCESS.md), [agent workflow](development/AGENT_WORKFLOW.md), [active board](development/ACTIVE_BOARD.md), [parallel work](development/PARALLEL_WORK.md), [ready](development/DEFINITION_OF_READY.md), [done](development/DEFINITION_OF_DONE.md)
