...
flowchart TB
  ...
  subgraph inflight [In flight — do not claim]
    i52["#52 Context assembly<br/>owner: bluefate<br/>status: In Progress"]
  end
...
| ---: | --- | --- | --- | --- |
| — | [#52](https://github.com/bluefate/spacebio-evidence-engine/issues/52) Context assembly | In Progress | Already claimed | **Do not claim** |
