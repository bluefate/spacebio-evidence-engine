...
flowchart TB
  ...
  subgraph inflight [In flight — do not claim]
    i30["#30 Sections<br/>status: In Progress"]
  end
...
| — | [#30](https://github.com/bluefate/spacebio-evidence-engine/issues/30) Sections | In Progress | In flight (see claim comment; `(branch on issue claim)`) | **Do not claim** |
