...
| Retrieval          | Vector search primary; optional hybrid + lexical rerank (off by default)                |
| Generation         | Provider abstraction; optional OpenAI `gpt-4o-mini`; $50/mo hard cap; local Ollama path |
...
| Compare / entities | Study compare UI shipped (`/compare`, inventory fields); advanced entity graph deferred |
...
| 2026-09-23 | Flag compare UI and optional hybrid/rerank as shipped; demo video complete                                                      |
