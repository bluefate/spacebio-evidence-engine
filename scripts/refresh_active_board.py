...
TRACKED: dict[int, dict[str, str | bool]] = {
    ...
    22: {"title": "Corpus inventory notebook", "critical": False},
    ...
    45: {"title": "PostgreSQL full-text search for chunks", "critical": False},
    ...
    56: {"title": "Claim-source mapping", "critical": False},
    ...
    67: {"title": "Developer retrieval diagnostics", "critical": False},
    68: {"title": "Improve web accessibility for core flows", "critical": False},
    ...
    74: {"title": "Graph extraction prototype", "critical": False},
